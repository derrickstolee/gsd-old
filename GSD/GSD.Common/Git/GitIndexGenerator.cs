...
namespace GSD.Common.Git
{
    public class GitIndexGenerator
    {
        ...
        public GitIndexGenerator(ITracer tracer, Enlistment enlistment, bool shouldHashIndex)
        {
            ...
            this.indexLockPath = Path.Combine(enlistment.DotGitRoot, GSDConstants.DotGit.IndexName + GSDConstants.DotGit.LockExtension);
        }
        ...
        {
            string indexPath = Path.Combine(this.enlistment.DotGitRoot, GSDConstants.DotGit.IndexName);
        ...
        private class LsTreeEntry
        {
            ...
            public static LsTreeEntry ParseFromLsTreeLine(string line)
            {
                if (DiffTreeResult.IsLsTreeLineOfType(line, DiffTreeResult.BlobMarker))
                {
                    ...
                    blobEntry.Sha = line.Substring(DiffTreeResult.TypeMarkerStartIndex + DiffTreeResult.BlobMarker.Length, GSDConstants.ShaStringLength);
