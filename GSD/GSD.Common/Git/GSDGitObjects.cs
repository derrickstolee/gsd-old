...
{
    public class GSDGitObjects : GitObjects
    {
        ...
        public GSDGitObjects(GSDContext context, GitObjectsHttpRequestor objectRequestor)
        ...
        protected GSDContext Context { get; private set; }
        ...
        private DownloadAndSaveObjectResult TryDownloadAndSaveObject(
            ...
            bool retryOnFailure)
        {
            if (objectId == GSDConstants.AllZeroSha)
            {
