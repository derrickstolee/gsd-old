...
namespace GSD.Common.Git
{
    public class DiffTreeResult
    {
        ...
        public static DiffTreeResult ParseFromDiffTreeLine(string line)
        {
             ...
             * :000000 040000 0000000000000000000000000000000000000000 cee82f9d431bf610404f67bcdda3fee76f0c1dd5 A\tGSD/FastFetch/Git
             * :000000 100644 0000000000000000000000000000000000000000 cdc036f9d561f14d908e0a0c337105b53c778e5e A\tGSD/FastFetch/Git/FastFetchGitObjects.cs
             * :040000 000000 f68b90da732791438d67c0326997a2d26e4c2de4 0000000000000000000000000000000000000000 D\tGSD/GSD.CLI
             * :100644 000000 1242fc97c612ff286a5f1221d569508600ca5e06 0000000000000000000000000000000000000000 D\tGSD/GSD.CLI/GSD.CLI.csproj
             * :040000 040000 3823348f91113a619eed8f48fe597cc9c7d088d8 fd56ff77b12a0b76567cb55ed4950272eac8b8f6 M\tGSD/GSD.Common
             * :100644 100644 57d9c737c8a48632cfbb12cae00c97d512b9f155 524d7dbcebd33e4007c52711d3f21b17373de454 M\tGSD/GSD.Common/GSD.Common.csproj
             *  ^-[0]  ^-[1]  ^-[2]                                    ^-[3]                                    ^-[4]
             *                                                                                                   ^-tab
             *                                                                                                     ^-[5]
             *
             ...
             * :100644 100644 3ac7d60a25bb772af1d5843c76e8a070c062dc5d c31a95125b8a6efd401488839a7ed1288ce01634 R094\tGSD/GSD.CLI/CommandLine/CloneVerb.cs\tGSD/GSD/CommandLine/CloneVerb.cs
             */
        ...
        public static DiffTreeResult ParseFromLsTreeLine(string line)
        {
             ...
             *
             * 040000 tree 73b881d52b607b0f3e9e620d36f556d3d233a11d\tGSD
             * 100644 blob 44c5f5cba4b29d31c2ad06eed51ea02af76c27c0\tReadme.md
             * 100755 blob 196142fbb753c0a3c7c6690323db7aa0a11f41ec\tScripts/BuildGSDForMac.sh
             * ^-mode ^-marker                                     ^-tab
             *             ^-sha                                     ^-path
             */
            ...
            else
            {
                if (IsLsTreeLineOfType(line, BlobMarker))
                {
                    ...
                    blobAdd.TargetSha = line.Substring(TypeMarkerStartIndex + BlobMarker.Length, GSDConstants.ShaStringLength);
        ...
        {
            return GitPathConverter.ConvertPathOctetsToUtf8(relativePath.Trim('"')).Replace(GSDConstants.GitPathSeparator, Path.DirectorySeparatorChar);
        }
    }
}
