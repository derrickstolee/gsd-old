namespace GSD.Common
{
    public class DiskLayoutVersion
    {
        ...
        // Increasing this version will make older versions of GSD unable to mount a repo that has been mounted by a newer
        // version of GSD.
        public int CurrentMajorVersion { get; }

        // The minor version should be bumped whenever there is an upgrade that can be safely ignored by older versions of GSD.
        ...
        // This is the last time GSD made a breaking change that required a reclone. This should not
