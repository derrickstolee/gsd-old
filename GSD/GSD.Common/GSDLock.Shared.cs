...
{
    // This file contains methods that are used by GSD.Hooks (compiled both by GSD.Common and GSD.Hooks).
    public partial class GSDLock
    {
        public static bool TryAcquireGSDLockForProcess(
            bool unattended,
            ...
            out string result)
        {
            ...
            switch (response.Result)
            {
                ...
                case NamedPipeMessages.AcquireLock.MountNotReadyResult:
                    result = "GSD has not finished initializing, please wait a few seconds and try again.";
                    return false;

                case NamedPipeMessages.AcquireLock.UnmountInProgressResult:
                    result = "GSD is unmounting.";
                    return false;

                case NamedPipeMessages.AcquireLock.DenyGSDResult:
                    message = response.DenyGSDMessage;
                    break;
        ...
        public static void ReleaseGSDLock(
            bool unattended,
            NamedPipeClient pipeClient,
            string fullCommand,
            int pid,
