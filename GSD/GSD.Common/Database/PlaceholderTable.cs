...
namespace GSD.Common.Database
{
    ...
    {
        private IGSDConnectionPool connectionPool;

        public PlaceholderTable(IGSDConnectionPool connectionPool)
        {
        ...
        public int GetCount()
        {
            ...
            {
                throw new GSDDatabaseException($"{nameof(PlaceholderTable)}.{nameof(this.GetCount)} Exception", ex);
            }
        }
        ...
        public void GetAllEntries(out List<IPlaceholderData> filePlaceholders, out List<IPlaceholderData> folderPlaceholders)
        {
            ...
            {
                throw new GSDDatabaseException($"{nameof(PlaceholderTable)}.{nameof(this.GetAllEntries)} Exception", ex);
            }
        }
        ...
        public HashSet<string> GetAllFilePaths()
        {
            ...
            {
                throw new GSDDatabaseException($"{nameof(PlaceholderTable)}.{nameof(this.GetAllFilePaths)} Exception", ex);
            }
        }
        ...
        public void AddFile(string path, string sha)
        {
            ...
            {
                throw new GSDDatabaseException($"Invalid SHA '{sha ?? "null"}' for file {path}", innerException: null);
            }
        ...
        public void Remove(string path)
        {
            ...
            {
                throw new GSDDatabaseException($"{nameof(PlaceholderTable)}.{nameof(this.Remove)}({path}) Exception", ex);
            }
        }
        ...
        private void Insert(PlaceholderData placeholder)
        {
            ...
            {
                throw new GSDDatabaseException($"{nameof(PlaceholderTable)}.{nameof(this.Insert)}({placeholder.Path}, {placeholder.PathType}, {placeholder.Sha}) Exception", ex);
            }
        }
