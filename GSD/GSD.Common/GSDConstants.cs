...
namespace GSD.Common
{
    public static partial class GSDConstants
    {
        ...
        public const string GSDEtwProviderName = "Microsoft.Git.GSD";
        public const string WorkingDirectoryRootName = "src";
        public const string UnattendedEnvironmentVariable = "GSD_UNATTENDED";

        public const string DefaultGSDCacheFolderName = ".gvfsCache";

        public const string GitIsNotInstalledError = "Could not find git.exe.  Ensure that Git is installed.";

        public static class GitConfig
        {
            public const string GSDPrefix = "gvfs.";
            public const string MaxRetriesConfig = GSDPrefix + "max-retries";
            public const string TimeoutSecondsConfig = GSDPrefix + "timeout-seconds";
            public const string GitStatusCacheBackoffConfig = GSDPrefix + "status-cache-backoff-seconds";
            public const string MountId = GSDPrefix + "mount-id";
            public const string EnlistmentId = GSDPrefix + "enlistment-id";
            public const string CacheServer = GSDPrefix + "cache-server";
            public const string DeprecatedCacheEndpointSuffix = ".cache-server-url";
            public const string HooksPrefix = GitConfig.GSDPrefix + "clone.default-";
            public const string GSDTelemetryId = GitConfig.GSDPrefix + "telemetry-id";
            public const string GSDTelemetryPipe = GitConfig.GSDPrefix + "telemetry-pipe";
            public const string IKey = GitConfig.GSDPrefix + "ikey";
            public const string HooksExtension = ".hooks";
        }

        public static class LocalGSDConfig
        {
        ...
        {
            public const string ServiceName = "GSD.Service";
            public const string LogDirectory = "Logs";
            public const string UIName = "GSD.Service.UI";
        }
        ...
        {
            public const string GSDConfig = "/gvfs/config";
            public const string GSDObjects = "/gvfs/objects";
            public const string GSDPrefetch = "/gvfs/prefetch";
            public const string GSDSizes = "/gvfs/sizes";
        ...
        public static class DotGSD
        {
            ...
            public static class Databases
            {
                ...
                public static readonly string GSD = Path.Combine(Name, "GSD.sqlite");
            }
        ...
        {
            public const string GSDUpgrade = "`gvfs upgrade`";
            public const string GSDUpgradeConfirm = "`gvfs upgrade --confirm`";
            public const string GSDUpgradeDryRun = "`gvfs upgrade --dry-run`";
            ...
            public const string SetUpgradeRingCommand = "To set or change upgrade ring, run `gvfs config " + LocalGSDConfig.UpgradeRing + " [\"Fast\"|\"Slow\"|\"None\"]` from a command prompt.";
            public const string ReminderNotification = "A new version of GSD is available. Run " + UpgradeVerbMessages.GSDUpgradeConfirm + " from an elevated command prompt to upgrade.";
            public const string UnmountRepoWarning = "Upgrade will unmount and remount gvfs repos, ensure you are at a stopping point.";
            public const string UpgradeInstallAdvice = "When ready, run " + UpgradeVerbMessages.GSDUpgradeConfirm + " from an elevated command prompt.";
        }
    }
}
