...
{
    /// <summary>
    /// Define messages used to communicate via the named-pipe in GSD.
    /// </summary>
    /// <remarks>
    /// This file contains only the message types that GSD.Hooks is interested
    /// in using. For all other messages see GSD.Common/NamedPipeMessages.
    /// </remarks>
    public static partial class NamedPipeMessages
    {
        ...
        public static class AcquireLock
        {
            ...
            public const string DenyGSDResult = "LockDeniedGSD";
            ...
            {
                public Response(string result, LockData responseData = null, string denyGSDMessage = null)
                {
                    this.Result = result;
                    this.ResponseData = responseData;
                    this.DenyGSDMessage = denyGSDMessage;
                }
                ...
                public string DenyGSDMessage { get; }
                ...
                public Message CreateMessage()
                {
                    ...
                    else if (this.DenyGSDMessage != null)
                    {
                        messageBody = this.DenyGSDMessage;
                    }
        ...
        public class LockData
        {
            ...
            /// <summary>
            /// Should the command actually acquire the GSDLock or
