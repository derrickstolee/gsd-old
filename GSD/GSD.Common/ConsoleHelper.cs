...
namespace GSD.Common
{
    public static class ConsoleHelper
    {
            ...
            finally
            {
                switch (result)
                {
                    ...
                    case ActionResult.Failure:
                        ...
                        output.WriteLine("Failed" + (gvfsLogEnlistmentRoot == null ? string.Empty : ". " + GetGSDLogMessage(gvfsLogEnlistmentRoot)));
                        break;
                }
            }
        ...
        public static string GetGSDLogMessage(string enlistmentRoot)
        {
