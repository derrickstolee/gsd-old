        ...
        public virtual bool TrySetupUpgradeApplicationDirectory(out string upgradeApplicationPath, out string error)
        {
            ...
            catch (UnauthorizedAccessException e)
            {
                error = string.Join(
                    ...
                    $"Make sure you have write permissions to directory {upgradeApplicationDirectory} and run {GSDConstants.UpgradeVerbMessages.GSDUpgradeConfirm} again.");
            }
            catch (IOException e)
            {
            ...
            if (string.IsNullOrEmpty(error))
            {
                ...
                upgradeApplicationPath = Path.Combine(
                    ...
                    GSDPlatform.Instance.Constants.GSDUpgraderExecutableName);
                return true;
            }
            else
            {
