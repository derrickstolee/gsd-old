    ...
    public class GSDService
    {
        ...
        private void ServiceThreadMain()
        {
            try
            {
                ...
                this.tracer.RelatedEvent(EventLevel.Informational, $"{nameof(GSDService)}_{nameof(this.ServiceThreadMain)}", metadata);
        ...
        {
            string currentUser = GSDPlatform.Instance.GetCurrentUser();
