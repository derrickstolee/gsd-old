...
namespace GSD.PreBuild
{
    public class GenerateInstallScripts : Task
    {
        ...
        [Required]
        public string GSDSetupFilename { get; set; }

        [Required]
        public string GitInstallBatPath { get; set; }

        [Required]
        public string GSDInstallBatPath { get; set; }
        ...
        public override bool Execute()
        {
            ...
            File.WriteAllText(
                this.GSDInstallBatPath,
                this.GetGSDInstallCommand());
            ...
            sb.AppendLine();
            sb.AppendLine(this.GetGSDInstallCommand());
        ...
        public string GetGSDInstallCommand()
        {
            return "%~dp0\\" + this.GSDSetupFilename + " /VERYSILENT /SUPPRESSMSGBOXES /NORESTART";
        }
    }
}
