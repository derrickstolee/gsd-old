...
namespace GSD.FunctionalTests.Tools
{
    public class ProjFSFilterInstaller
    {
        ...
        private const string GSDInstallPath = @"C:\Program Files\GSD";
        private const string NativeProjFSLibInstallLocation = GSDInstallPath + @"\ProjFS\ProjectedFSLib.dll";

        private const string PrjfltInfName = "prjflt.inf";
        private const string PrjfltInfInstallFolder = GSDInstallPath + @"\Filter";
        ...
        private static void InstallProjFSViaINF()
        {
            ...
            File.Copy(NativeProjFSLibInstallLocation, GSDInstallPath + @"\ProjectedFSLib.dll", overwrite: true);
