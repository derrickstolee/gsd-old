...
namespace GSD.FunctionalTests.Tests.GitCommands
{
    ...
    public class GitCommandsTests : GitRepoTests
    {
        ...
        public void MoveFileFromInsideRepoToOutsideRepoAndCommit()
        {
            ...
            string gvfsTargetFolder = "MoveFileFromInsideRepoToOutsideRepoAndCommit_GSDTarget";
        ...
        public void OpenFileThenCheckout()
        {
            ...
            // will ensure that GSD is still reporting the edited file as modified.
        ...
        public void EditFileNeedingUtf8Encoding()
        {
            ...
            GSDHelpers.ModifiedPathsShouldNotContain(this.Enlistment, this.FileSystem, relativeGitPath);
            this.ValidateGitCommand("status");
            ...
            GSDHelpers.ModifiedPathsShouldContain(this.Enlistment, this.FileSystem, relativeGitPath);
        }
