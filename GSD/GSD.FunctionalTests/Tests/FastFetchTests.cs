...
namespace GSD.FunctionalTests.Tests
{
    ...
    public class FastFetchTests
    {
        ...
        public void InitControlRepo()
        {
            ...
            GitProcess.Invoke(this.fastFetchBaseRoot, "clone -b " + Settings.Default.Commitish + " " + GSDTestConfig.RepoToClone + " " + this.fastFetchControlRoot);
        }
        ...
        public void InitRepo()
        {
            ...
            GitProcess.Invoke(this.fastFetchRepoRoot, "remote add origin " + GSDTestConfig.RepoToClone);
        }
        ...
        {
            this.RunFastFetch("--checkout --folders \"/GSD\" -b " + Settings.Default.Commitish);
            ...
            dirs.SequenceEqual(new[]
            {
                ...
                Path.Combine(this.fastFetchRepoRoot, "GSD"),
                Path.Combine(this.fastFetchRepoRoot, "GSD.sln")
            });

            Directory.EnumerateFileSystemEntries(Path.Combine(this.fastFetchRepoRoot, "GSD"), "*", SearchOption.AllDirectories)
                .Count()
                .ShouldEqual(345);

            this.AllFetchedFilePathsShouldPassCheck(path => path.StartsWith("GSD", StringComparison.OrdinalIgnoreCase));
        }
        ...
        public void CanFetchAndCheckoutMultipleTimesUsingForceCheckoutFlag()
        {
            ...
            this.RunFastFetch($"--checkout --folders \"/GSD;/Scripts\" -b {Settings.Default.Commitish} --force-checkout");
        ...
        public void ForceCheckoutRequiresCheckout()
        {
            ...
            ProcessResult result = this.RunFastFetch($"--force-checkout --folders \"/GSD;/Scripts\" -b {Settings.Default.Commitish}");
        ...
        {
            string folderPath = Path.Combine("GSD", "GSD", "Properties");
            ...
            dirs = Directory.EnumerateFileSystemEntries(Path.Combine(this.fastFetchRepoRoot, "GSD"), "*", SearchOption.AllDirectories).ToList();
            dirs.SequenceEqual(new[]
            {
                Path.Combine(this.fastFetchRepoRoot, "GSD", "GSD"),
                Path.Combine(this.fastFetchRepoRoot, "GSD", "GSD", "Properties"),
                Path.Combine(this.fastFetchRepoRoot, "GSD", "GSD", "Properties", "AssemblyInfo.cs"),
            });
