...
%~dp0\..\..\BuildOutput\GSD.UnitTests\bin\x64\%Configuration%\GSD.UnitTests.exe";
...
%~dp0\..\..\BuildOutput\GSD.FunctionalTests\bin\x64\%Configuration%\GSD.FunctionalTests.exe %2";
        ...
        // This test needs the GSD folder to not exist on physical disk yet, so run it first
        [TestCase, Order(1)]
        public void MoveUnhydratedFileToUnhydratedFolderAndWrite()
        {
            ...
            // Assume there will always be a GSD folder when running tests
            string testFolderName = "GSD";
