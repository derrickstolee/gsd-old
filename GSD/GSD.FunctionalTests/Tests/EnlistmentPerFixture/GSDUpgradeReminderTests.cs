...
namespace GSD.FunctionalTests.Tests.EnlistmentPerFixture
{
    ...
    public class UpgradeReminderTests : TestsWithEnlistmentPerFixture
    {
        ...
        {
            GSDProcess gvfs = new GSDProcess(GSDTestConfig.PathToGSD, enlistmentRoot: null, localCacheRoot: null);
        ...
        private bool ServiceLogContainsUpgradeMessaging()
        {
            ...
            // file. GSD.Service should schedule the timer as it starts.
        ...
        {
            this.RunGSD($"config {UpgradeRingKey} {value}");
        }

        private string RunUpgradeCommand()
        {
            return this.RunGSD("upgrade");
        }

        private string RunGSD(string argument)
        {
            ProcessResult result = ProcessHelper.Run(GSDTestConfig.PathToGSD, argument);
