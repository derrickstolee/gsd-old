...
namespace GSD.FunctionalTests.Tests.EnlistmentPerFixture
{
    ...
    public class MultithreadedReadWriteTests : TestsWithEnlistmentPerFixture
    {
        ...
        public void CanReadVirtualFileInParallel()
        {
            ...
            string fileName = Path.Combine("GSD", "GSD.FunctionalTests", "Tests", "LongRunningEnlistment", "GitMoveRenameTests.cs");
        ...
        public void CanReadHydratedPlaceholderInParallel()
        {
            ...
            string fileName = Path.Combine("GSD", "GSD.FunctionalTests", "Tests", "LongRunningEnlistment", "WorkingDirectoryTests.cs");
            string virtualPath = this.Enlistment.GetVirtualPathTo(fileName);
