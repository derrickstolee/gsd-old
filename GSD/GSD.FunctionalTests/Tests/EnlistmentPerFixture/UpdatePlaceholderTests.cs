    ...
    public class UpdatePlaceholderTests : TestsWithEnlistmentPerFixture
    {
        ...
        public void LockWithFullShareUpdateAndDelete()
        {
            ...
            else
            {
                ...
                GSDHelpers.ModifiedPathsShouldContain(this.Enlistment, this.fileSystem, TestParentFolderName + "/LockToPreventUpdateAndDelete/" + testFileUpdate4Name);
            }
        ...
        public void FileProjectedAfterPlaceholderDeleteFileAndCheckout()
        {
            ...
            GSDHelpers.ModifiedPathsShouldNotContain(this.Enlistment, this.fileSystem, TestParentFolderName + "/FileProjectedAfterPlaceholderDeleteFileAndCheckout/" + testFile1Name);
            GSDHelpers.ModifiedPathsShouldNotContain(this.Enlistment, this.fileSystem, TestParentFolderName + "/FileProjectedAfterPlaceholderDeleteFileAndCheckout/" + testFile2Name);
            GSDHelpers.ModifiedPathsShouldNotContain(this.Enlistment, this.fileSystem, TestParentFolderName + "/FileProjectedAfterPlaceholderDeleteFileAndCheckout/" + testFile3Name);
        ...
        public void FullFilesDontAffectThePlaceholderDatabase()
        {
            ...
            GSDHelpers.GetAllSQLitePlaceholdersAsString(placeholderDatabase).ShouldEqual(placeholdersBefore);
        ...
        {
            GitHelpers.CheckGitCommandAgainstGSDRepo(this.Enlistment.RepoRoot, "checkout -- " + gitPath);
        }

        private void GitCheckoutCommitId(string commitId)
        {
            this.InvokeGitAgainstGSDRepo("checkout " + commitId).Errors.ShouldContain("HEAD is now at " + commitId);
        }
