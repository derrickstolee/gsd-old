...
";
        ...
        {
            string filePath = Path.Combine("GSD", "FastFetch", "Properties", "AssemblyInfo.cs");
        ...
        public void AppendToHydratedFileAfterRemount()
        {
            ...
            GSDHelpers.ModifiedPathsShouldNotContain(this.Enlistment, this.fileSystem, fileToAppendEntry);
            ...
            this.Enlistment.WaitForBackgroundOperations();
            GSDHelpers.ModifiedPathsShouldContain(this.Enlistment, this.fileSystem, fileToAppendEntry);
        ...
        public void AllNullObjectRedownloaded()
        {
            ...
            string corruptObjectFolderPath = Path.Combine(this.Enlistment.DotGSDRoot, "CorruptObjects");
        ...
        private class NativeTests
        {
            ...
            [DllImport("GSD.NativeTests.dll", CharSet = CharSet.Ansi)]
