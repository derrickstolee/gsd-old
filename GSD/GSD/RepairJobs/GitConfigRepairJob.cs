...
namespace GSD.RepairJobs
{
    ...
    {
        public GitConfigRepairJob(ITracer tracer, TextWriter output, GSDEnlistment enlistment)
        ...
        {
            string configPath = Path.Combine(this.Enlistment.WorkingDirectoryRoot, GSDConstants.DotGit.Config);
            ...
            if (!GSDVerb.TrySetRequiredGitConfigSettings(this.Enlistment) ||
                !GSDVerb.TrySetOptionalGitConfigSettings(this.Enlistment))
            {
