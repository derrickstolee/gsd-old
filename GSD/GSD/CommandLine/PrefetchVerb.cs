...
namespace GSD.CommandLine
{
    ...
    public class PrefetchVerb : GSDVerb.ForExistingEnlistment
    {
        ...
        public ServerGSDConfig ServerGSDConfig { get; set; }
            ...
            out CacheServerInfo cacheServer)
        {
            ...
            ServerGSDConfig serverGSDConfig = this.ServerGSDConfig;
            if (!this.SkipVersionCheck)
            {
                ...
                if (cacheServer == null)
                {
                    ...
                    cacheServer = cacheServerResolver.ResolveNameFromRemote(cacheServerUrl, serverGSDConfig);
                }

                this.ValidateClientVersions(tracer, enlistment, serverGSDConfig, showWarnings: false);
            ...
            out FileBasedDictionary<string, string> lastPrefetchArgs)
        {
            ...
            if (!FileBasedDictionary<string, string>.TryCreate(
                    tracer,
                    Path.Combine(enlistment.DotGSDRoot, "LastBlobPrefetch.dat"),
            ...
            GitProcess.Result result = gitProcess.RevParse(GSDConstants.DotGit.HeadName);
