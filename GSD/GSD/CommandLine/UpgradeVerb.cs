...
{
    [Verb(UpgradeVerbName, HelpText = "Checks for new GSD release, downloads and installs it when available.")]
    public class UpgradeVerb : GSDVerb.ForNoEnlistment
    {
            ...
            TextWriter output)
        {
            ...
            this.Output = output;
            this.productUpgraderPlatformStrategy = GSDPlatform.Instance.CreateProductUpgraderPlatformInteractions(fileSystem, tracer);
        }
        ...
        private bool TryRunProductUpgrade()
        {
            ...
            {
                this.ReportInfoToConsole($"Cannot upgrade GSD on this machine.");
            ...
            else
            {
                string advisoryMessage = string.Join(
                        Environment.NewLine,
                        GSDConstants.UpgradeVerbMessages.UnmountRepoWarning,
                        GSDConstants.UpgradeVerbMessages.UpgradeInstallAdvice);
        ...
        private bool TryRunInstaller(out string consoleError)
        {
            ...
            string errorMessage = null;
            bool supportsInlineUpgrade = GSDPlatform.Instance.Constants.SupportsUpgradeWhileRunning;
