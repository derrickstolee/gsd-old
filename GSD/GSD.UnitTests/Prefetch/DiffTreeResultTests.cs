...
namespace GSD.UnitTests.Prefetch
{
    ...
    public class DiffTreeResultTests
    {
        ...
        private const string TestTreePath1 = "Test/GSD";
        ...
        [TestCase("040000 tree 73b881d52b607b0f3e9e620d36f556d3d233a11d\tGSD", DiffTreeResult.TreeMarker, true)]
        [TestCase("040000 tree 73b881d52b607b0f3e9e620d36f556d3d233a11d\tGSD", DiffTreeResult.BlobMarker, false)]
        [TestCase("100644 blob 44c5f5cba4b29d31c2ad06eed51ea02af76c27c0\tReadme.md", DiffTreeResult.BlobMarker, true)]
        [TestCase("100755 blob 196142fbb753c0a3c7c6690323db7aa0a11f41ec\tScripts / BuildGSDForMac.sh", DiffTreeResult.BlobMarker, true)]
        [TestCase("100755 blob 196142fbb753c0a3c7c6690323db7aa0a11f41ec\tScripts / BuildGSDForMac.sh", DiffTreeResult.BlobMarker, true)]
