...
namespace GSD.UnitTests.Prefetch
{
    ...
    public class DiffHelperTests
    {
        ...
        public void CanParseDiffForwards()
        {
            ...
            DiffHelper diffForwards = new DiffHelper(tracer, new MockGSDEnlistment(), new List<string>(), new List<string>(), includeSymLinks: this.IncludeSymLinks);
        ...
        {
            MockTracer tracer = new MockTracer();
            DiffHelper diffBackwards = new DiffHelper(tracer, new Mock.Common.MockGSDEnlistment(), new List<string>(), new List<string>(), includeSymLinks: this.IncludeSymLinks);
        ...
        public void DetectsFailuresInDiffTree()
        {
            ...
            DiffHelper diffBackwards = new DiffHelper(tracer, new Mock.Common.MockGSDEnlistment(), gitProcess, new List<string>(), new List<string>(), includeSymLinks: this.IncludeSymLinks);
