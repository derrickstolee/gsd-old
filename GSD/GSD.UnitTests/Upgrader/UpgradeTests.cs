...
namespace GSD.UnitTests.Upgrader
{
    public abstract class UpgradeTests
    {
        ...
        protected const string LocalGSDVersion = "1.0.18115.1";
        ...
        protected MockLocalGSDConfig LocalConfig { get; private set; }

        public virtual void Setup()
        {
            this.Tracer = new MockTracer();
            this.FileSystem = new MockFileSystem(new MockDirectory(@"mock:\GSD.Upgrades\Download", null, null));
            this.Output = new MockTextWriter();
            this.PrerunChecker = new MockInstallerPrerunChecker(this.Tracer);
            this.LocalConfig = new MockLocalGSDConfig();
        ...
        protected void VerifyConfig(
            GSD.Common.GitHubUpgrader.GitHubUpgraderConfig.RingType ring,
