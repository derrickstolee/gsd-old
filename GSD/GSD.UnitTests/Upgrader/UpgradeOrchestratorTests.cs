...
namespace GSD.UnitTests.Upgrader
{
    ...
    {
        private const string GSDVersion = "1.1.18115.1";
        ...
        private Mock<LocalGSDConfig> MoqLocalConfig { get; set; }
        ...
        public void Setup()
        {
            ...
            this.SetUpgradeAvailable(new Version(GSDVersion), error: null);
        }
