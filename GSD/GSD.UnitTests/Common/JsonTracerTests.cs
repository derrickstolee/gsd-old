...
using GSD.UnitTests.Mock.Common.Tracing;
...
namespace GSD.UnitTests.Common
{
    ...
    public class JsonTracerTests
    {
        ...
        {
            using (JsonTracer tracer = new JsonTracer("Microsoft-GSD-Test", "EventsAreFilteredByVerbosity1", disableTelemetry: true))
            ...
            using (JsonTracer tracer = new JsonTracer("Microsoft-GSD-Test", "EventsAreFilteredByVerbosity2", disableTelemetry: true))
        ...
        public void EventsAreFilteredByKeyword()
        {
            ...
            using (JsonTracer tracer = new JsonTracer("Microsoft-GSD-Test", "EventsAreFilteredByKeyword1", disableTelemetry: true))
            ...
            using (JsonTracer tracer = new JsonTracer("Microsoft-GSD-Test", "EventsAreFilteredByKeyword2", disableTelemetry: true))
            using (MockListener listener = new MockListener(EventLevel.Verbose, Keywords.Any))
            {
                tracer.AddEventListener(listener);
            ...
            using (JsonTracer tracer = new JsonTracer("Microsoft-GSD-Test", "EventsAreFilteredByKeyword3", disableTelemetry: true))
        ...
        {
            using (JsonTracer tracer = new JsonTracer("Microsoft-GSD-Test", "EventMetadataWithKeywordsIsOptional", disableTelemetry: true))
            using (MockListener listener = new MockListener(EventLevel.Verbose, Keywords.Any))
            {
                tracer.AddEventListener(listener);
        ...
        {
            using (JsonTracer tracer = new JsonTracer("Microsoft-GSD-Test", "StartEventDoesNotDispatchTelemetry", disableTelemetry: true))
        ...
        {
            using (JsonTracer tracer = new JsonTracer("Microsoft-GSD-Test", "StopEventIsDispatchedOnDispose", disableTelemetry: true))
            using (MockListener listener = new MockListener(EventLevel.Verbose, Keywords.Telemetry))
            {
                tracer.AddEventListener(listener);
