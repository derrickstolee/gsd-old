...
namespace GSD.UnitTests.Common
{
    ...
    public class GitVersionTests
    {
        ...
        {
            this.ParseAndValidateInstallerVersion("Git-1.2.3.gvfs.4.5.gb16030b-64-bit" + GSDPlatform.Instance.Constants.InstallerExtension);
            this.ParseAndValidateInstallerVersion("git-1.2.3.gvfs.4.5.gb16030b-64-bit" + GSDPlatform.Instance.Constants.InstallerExtension);
            this.ParseAndValidateInstallerVersion("Git-1.2.3.gvfs.4.5.gb16030b-64-bit" + GSDPlatform.Instance.Constants.InstallerExtension);
        }
        ...
        {
            GitVersion version;
            bool success = GitVersion.TryParseInstallerName(installerName, GSDPlatform.Instance.Constants.InstallerExtension, out version);
