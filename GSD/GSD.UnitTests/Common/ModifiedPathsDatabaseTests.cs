...
";
        ...
        {
            ModifiedPathsDatabase modifiedPathsDatabase = CreateModifiedPathsDatabase(ExistingEntries.Replace("\n", "\r\n"));
        ...
        {
            ModifiedPathsDatabase modifiedPathsDatabase = CreateModifiedPathsDatabase(EntriesToCompress.Replace("\n", "\r\n"));
        ...
        {
            return path.Replace(GSDConstants.GitPathSeparator, Path.DirectorySeparatorChar);
        }
