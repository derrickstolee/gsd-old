...
namespace GSD.UnitTests.Common.Database
{
    ...
    public class PlaceholderTableTests
    {
        ...
        {
            Mock<IGSDConnectionPool> mockConnectionPool = new Mock<IGSDConnectionPool>(MockBehavior.Strict);
        ...
        public void CreateTableThrowsExceptionNotWrappedInGSDDatabaseException()
        {
            Mock<IDbCommand> mockCommand = new Mock<IDbCommand>(MockBehavior.Strict);
            mockCommand.SetupSet(x => x.CommandText = "CREATE TABLE IF NOT EXISTS [Placeholder] (path TEXT PRIMARY KEY COLLATE NOCASE, pathType TINYINT NOT NULL, sha char(40) ) WITHOUT ROWID;");
        ...
        [TestCase]
        [Category(CategoryConstants.ExceptionExpected)]
        public void GetCountThrowsGSDDatabaseException()
        {
            this.TestPlaceholders(
                (placeholders, mockCommand) =>
                {
                    ...
                    GSDDatabaseException ex = Assert.Throws<GSDDatabaseException>(() => placeholders.GetCount());
        ...
        [TestCase]
        [Category(CategoryConstants.ExceptionExpected)]
        public void GetAllFilePathsThrowsGSDDatabaseException()
        {
            this.TestPlaceholdersWithReader(
               (placeholders, mockCommand, mockReader) =>
               {
                   ...
                   GSDDatabaseException ex = Assert.Throws<GSDDatabaseException>(() => placeholders.GetAllFilePaths());
        ...
        [TestCase]
        [Category(CategoryConstants.ExceptionExpected)]
        public void GetAllEntriesThrowsGSDDatabaseException()
        {
            ...
            this.TestPlaceholdersWithReader(
               (placeholders, mockCommand, mockReader) =>
               {
                   ...
                   GSDDatabaseException ex = Assert.Throws<GSDDatabaseException>(() => placeholders.GetAllEntries(out List<IPlaceholderData> filePlaceholders, out List<IPlaceholderData> folderPlaceholders));
        ...
        public void AddFilePlaceholderDataWithNullShaThrowsException()
        {
            ...
            GSDDatabaseException ex = Assert.Throws<GSDDatabaseException>(() => this.TestPlaceholdersInsert(
        ...
        [TestCase]
        [Category(CategoryConstants.ExceptionExpected)]
        public void AddPlaceholderDataThrowsGSDDatabaseException()
        {
            PlaceholderTable.PlaceholderData placeholderData = new PlaceholderTable.PlaceholderData()
            {
                Path = DefaultPath,
        ...
        [TestCase]
        [Category(CategoryConstants.ExceptionExpected)]
        public void AddFileThrowsGSDDatabaseException()
        {
            GSDDatabaseException ex = Assert.Throws<GSDDatabaseException>(() => this.TestPlaceholdersInsert(
                placeholders => placeholders.AddFile(DefaultPath, DefaultSha),
                DefaultPath,
        ...
        [TestCase]
        [Category(CategoryConstants.ExceptionExpected)]
        public void AddPartialFolderThrowsGSDDatabaseException()
        {
            GSDDatabaseException ex = Assert.Throws<GSDDatabaseException>(() => this.TestPlaceholdersInsert(
                placeholders => placeholders.AddPartialFolder(DefaultPath),
                DefaultPath,
        ...
        [TestCase]
        [Category(CategoryConstants.ExceptionExpected)]
        public void AddExpandedFolderThrowsGSDDatabaseException()
        {
            GSDDatabaseException ex = Assert.Throws<GSDDatabaseException>(() => this.TestPlaceholdersInsert(
                placeholders => placeholders.AddExpandedFolder(DefaultPath),
                DefaultPath,
        ...
        [TestCase]
        [Category(CategoryConstants.ExceptionExpected)]
        public void AddPossibleTombstoneFolderThrowsGSDDatabaseException()
        {
            GSDDatabaseException ex = Assert.Throws<GSDDatabaseException>(() => this.TestPlaceholdersInsert(
                placeholders => placeholders.AddPossibleTombstoneFolder(DefaultPath),
                DefaultPath,
        ...
        [TestCase]
        [Category(CategoryConstants.ExceptionExpected)]
        public void RemoveThrowsGSDDatabaseException()
        {
            this.TestPlaceholders(
                (placeholders, mockCommand) =>
                {
                    ...
                    GSDDatabaseException ex = Assert.Throws<GSDDatabaseException>(() => placeholders.Remove(DefaultPath));
