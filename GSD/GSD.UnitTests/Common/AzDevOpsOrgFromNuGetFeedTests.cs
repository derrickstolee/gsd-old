...
namespace GSD.UnitTests.Common
{
    ...
    {
        [TestCase("https://pkgs.dev.azure.com/test-pat/_packaging/Test-GSD-Installers-Custom/nuget/v3/index.json", "https://test-pat.visualstudio.com")]
        [TestCase("https://PKGS.DEV.azure.com/test-pat/_packaging/Test-GSD-Installers-Custom/nuget/v3/index.json", "https://test-pat.visualstudio.com")]
        [TestCase("https://dev.azure.com/test-pat/_packaging/Test-GSD-Installers-Custom/nuget/v3/index.json", null)]
        [TestCase("http://pkgs.dev.azure.com/test-pat/_packaging/Test-GSD-Installers-Custom/nuget/v3/index.json", null)]
