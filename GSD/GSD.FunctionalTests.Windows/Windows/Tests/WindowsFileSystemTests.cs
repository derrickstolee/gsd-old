...
namespace GSD.FunctionalTests.Windows.Windows.Tests
{
    [TestFixture]
    ...
    public class WindowsFileSystemTests : TestsWithEnlistmentPerFixture
    {
        ...
        public void NativeEnumerationErrorsMatchNTFS()
        {
            ...
            string nonExistentPhysicalPath = Path.Combine(this.Enlistment.DotGSDRoot, "this_does_not_exist");
        ...
        public void NativeEnumerationErrorsMatchNTFSForNestedFolder()
        {
            ...
            this.Enlistment.GetVirtualPathTo("GSD").ShouldBeADirectory(fileSystem);
            string nonExistentVirtualPath = this.Enlistment.GetVirtualPathTo("GSD\\this_does_not_exist");
            nonExistentVirtualPath.ShouldNotExistOnDisk(fileSystem);

            this.Enlistment.DotGSDRoot.ShouldBeADirectory(fileSystem);
            string nonExistentPhysicalPath = Path.Combine(this.Enlistment.DotGSDRoot, "this_does_not_exist");
            nonExistentPhysicalPath.ShouldNotExistOnDisk(fileSystem);
        ...
        public void NativeEnumerationErrorsMatchNTFSForEmptyNewFolder()
        {
            ...
            string newPhysicalFolderPath = Path.Combine(this.Enlistment.DotGSDRoot, "new_folder");
        ...
        {
            string existingFilePhysicalPath = Path.Combine(this.Enlistment.DotGSDRoot, "existingFileTest.txt");
        ...
        private class FileRunnersAndFolders
        {
            ...
            public static void ShouldNotExistOnDisk(GSDFunctionalTestEnlistment enlistment, FileSystemRunner fileSystem, string filename, string parentFolder)
            {
