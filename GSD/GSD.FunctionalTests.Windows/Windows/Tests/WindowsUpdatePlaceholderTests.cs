...
namespace GSD.FunctionalTests.Tests.EnlistmentPerFixture
{
    ...
    public class WindowsUpdatePlaceholderTests : TestsWithEnlistmentPerFixture
    {
        ...
        public void LockToPreventDelete_MultipleFiles()
        {
            ...
            GSDHelpers.ModifiedPathsShouldContain(this.Enlistment, this.fileSystem, TestParentFolderName + "/LockToPreventDelete/" + testFile2Name);
            GSDHelpers.ModifiedPathsShouldContain(this.Enlistment, this.fileSystem, TestParentFolderName + "/LockToPreventDelete/" + testFile3Name);
            GSDHelpers.ModifiedPathsShouldContain(this.Enlistment, this.fileSystem, TestParentFolderName + "/LockToPreventDelete/" + testFile4Name);
        ...
        public void LockToPreventUpdate_SingleFile()
        {
            ...
            this.GitStatusShouldBeClean(OldCommitId);
            GSDHelpers.ModifiedPathsShouldContain(this.Enlistment, this.fileSystem, TestParentFolderName + "/LockToPreventUpdate/" + testFile1Name);
        ...
        public void LockMoreThanMaxReportedFileNames()
        {
            ...
            try
            {
                ...
                ProcessResult result = this.InvokeGitAgainstGSDRepo("checkout " + OldCommitId);
                result.Errors.ShouldContain(
                    "GSD failed to update 102 files, run 'git status' to check the status of files in the repo");
                ...
                GitHelpers.CheckGitCommandAgainstGSDRepo(this.Enlistment.RepoRoot, "status -u", expectedOutputStrings.ToArray());
            }
            finally
            {
