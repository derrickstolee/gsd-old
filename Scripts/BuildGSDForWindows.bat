...
IF "%2"=="" (SET "GSDVersion=0.2.173.2") ELSE (SET "GSDVersion=%2")
...
%msbuild% %VFS_SRCDIR%\GSD.sln /p:GSDVersion=%GSDVersion% /p:Configuration=%SolutionConfiguration% /p:Platform=x64 || exit /b 1
